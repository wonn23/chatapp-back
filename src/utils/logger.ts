import { format as _format, createLogger, transports as _transports, Logger } from 'winston';
...
const logger: Logger = createLogger({
  ...
  format: combine(
    ...
    label({ label: 'KnockKnock 어플리케이션' }), // 어플리케이션 이름
    logFormat, // log 출력 포맷
